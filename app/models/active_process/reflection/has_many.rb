class ActiveProcess::Reflection::HasMany
  ...
  def conditions() klass < ActiveProcess::Instance ? {type: class_name} : {} end
  private
    ...
    def first_join_details()
      {class_name: 'ActiveProcess::JoinedInstance', as: (first? ? :first_active_record : :second_active_record)}
    end
